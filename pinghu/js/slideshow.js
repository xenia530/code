...
(function () {
    jQuery.noConflict();
    jQuery('#slideshow').skitter({ width: 1000, height: 171, animation: 'random', velocity: 1.3, interval: 3500, thumb_width: '70px', thumb_height: '40px', caption: 'bottom', caption_width: '250', navigation: 1, fullscreen: false })
})();
